...
int main()
{
    ...
    RenderWindow app(VideoMode(ScreenWidth, ScreenHeight), "Car Racing Game!");
    app.setFramerateLimit(60);

    Texture t1,t2,t3;
    t1.loadFromFile("images/background.png");
    t2.loadFromFile("images/car.png");
    t3.loadFromFile("images/finishing-Line.png");
    t1.setSmooth(true);
    t2.setSmooth(true);
    t3.setSmooth(true);

    Sprite sBackground(t1), sCar(t2), sLine(t3);
    sBackground.scale(2,2);
    sCar.setOrigin(22, 22);
    sLine.scale(1,1);

    sf::RectangleShape finishLine(sf::Vector2f(20.f,20.f));
    finishLine.setFillColor(sf::Color(255,145,175));
    ...
    while (app.isOpen())
    {
        ...
        //if (car[0].x>ScreenWidth/2) offsetX = car[0].x-ScreenWidth/2;
        //if (car[0].y>ScreenHeight/2) offsetY = car[0].y-ScreenHeight/2;


        sBackground.setPosition(-offsetX,-offsetY);
        sLine.setPosition(0,0);
